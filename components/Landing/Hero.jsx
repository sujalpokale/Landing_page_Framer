            ...
            <div className='max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-6 flex items-center justify-between'>
                <a href='/' className='flex items-center gap-3' aria-label={`{$brandName} home`}>
                    <svg width='36' height='36' viewBox='0 0 24 24' fill='none' aria-hidden='true'>
                        ...
                        <path d="M7 12h10" stroke="#fff" strokeWidth="1.5" strokeLinecap='round'></path>
                    </svg>
                ...
                <div className='md:hidden'>
                    <button aria-label='Open menu' className='p-2 rounded-md border'>
                        <svg width="20" height="20" viewBox='0 0 24 24' fill='none'>
                            <path d='M4 6h16M4 12h16M4 18h16' stroke='#111827' strokeWidth="1.5" strokeLinecap='round'></path>
                        </svg>
                    </button> 
                </div>
            </div>
            <section aria-labelledby='hero-heading' className='bg-gradient-to-b from-white to-gray-50'>
                <div className='max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-16 md:py-32 flex flex-col-reverse lg:flex-row items-center gap-12'>
                    <div className='w-full lg:w-6/12'>
                        <h1 id="hero-heading" className='text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight'>
                            {heroTitle}
                        </h1>
                        <p className='mt-4 text-gray-600 text-lg sm:text-xl'>{heroSubtitle}</p>
                        <div className='mt-8 flex flex-col sm:flex-row gap-3'>
                            <a href='#signup' className='inline-flex items-center px-5 py-3 rounded-md bg-black text-white text-sm font-medium'>
                                {ctaPrimary}
                            </a>
                            <a href='#demo' className='inline-flex items-center justify-center px-5 py-3 rounded-md border text-sm font-medium'>
                                {ctaSecondary}
                            </a>
                        </div>
